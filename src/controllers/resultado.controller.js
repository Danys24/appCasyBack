...
export const crearResultadoPrueba = async(req, res) => {
    try{
        ...
        const resultado = await crearResultado(TABLAS, idPaso, idCiclo,idCaso, observacion,estado);
...
export const obtenerResultadosByIdCasoCiclo = async(req, res) => {
    ...
    try{
        const resultado = await resultsByIdCasoCiclo(TABLAS,TABLAR,TABLAP, req.params.idCaso, req.params.idCiclo);
...
export const obtenerEvidenciaPorIdResultado = async(req, res) => {
